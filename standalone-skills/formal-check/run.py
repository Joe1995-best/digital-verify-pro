#!/usr/bin/env python3
"""formal-check — Formal property verification"""
...
logger = get_logger("formal-check")


def parse_args(argv=None):
    """Parse CLI arguments matching skill_spec.json interface.signature"""
    ap = argparse.ArgumentParser(description="Formal property verification")
...
def main(argv=None) -> int:
    ...
    if errors:
        ...
        write_result(status="fail", module="formal-check", errors=errors,
    ...
    write_result(
        ...
        module=args.spec.stem if args.spec and args.spec.exists() else "formal-check",
