#!/usr/bin/env python3
"""test-generator — Generate UVM test sequences"""
...
def parse_args(argv=None):
    ...
    ap = argparse.ArgumentParser(description="Generate UVM test sequences")
    ...
    ap.add_argument("--result", type=Path, default=None, help="result.json path override")
        ap.add_argument("--gaps", type=Path, help="Coverage gaps JSON")
...
def main(argv=None) -> int:
    ...
    if errors:
        ...
        write_result(status="fail", module="test-generator", errors=errors,
    ...
    write_result(
        ...
        module=args.spec.stem if args.spec and args.spec.exists() else "test-generator",
