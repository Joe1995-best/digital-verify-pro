#!/usr/bin/env python3
"""assertion-gen — Generate SVA assertions from spec"""
...
logger = get_logger("assertion-gen")


def parse_args(argv=None):
    """Parse CLI arguments matching skill_spec.json interface.signature"""
    ap = argparse.ArgumentParser(description="Generate SVA assertions from spec")
...
def main(argv=None) -> int:
    ...
    if errors:
        ...
        write_result(status="fail", module="assertion-gen", errors=errors,
    ...
    write_result(
        ...
        module=args.spec.stem if args.spec and args.spec.exists() else "assertion-gen",
