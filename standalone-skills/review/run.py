#!/usr/bin/env python3
"""review — Cross-model RTL code review"""
...
def parse_args(argv=None):
    ...
    ap = argparse.ArgumentParser(description="Cross-model RTL code review")
...
def main(argv=None) -> int:
    ...
    if errors:
        ...
        write_result(status="fail", module="review", errors=errors,
    ...
    write_result(
        ...
        module=args.spec.stem if args.spec and args.spec.exists() else "review",
