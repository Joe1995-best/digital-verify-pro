#!/usr/bin/env python3
"""scoreboard-gen — Generate UVM scoreboard and checker"""
...
logger = get_logger("scoreboard-gen")


def parse_args(argv=None):
    """Parse CLI arguments matching skill_spec.json interface.signature"""
    ap = argparse.ArgumentParser(description="Generate UVM scoreboard and checker")
...
def main(argv=None) -> int:
    ...
    if errors:
        ...
        write_result(status="fail", module="scoreboard-gen", errors=errors,
    ...
    write_result(
        ...
        module=args.spec.stem if args.spec and args.spec.exists() else "scoreboard-gen",
