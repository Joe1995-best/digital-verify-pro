#!/usr/bin/env python3
"""env-builder — Generate UVM verification environment skeleton"""
...
logger = get_logger("env-builder")


def parse_args(argv=None):
    """Parse CLI arguments matching skill_spec.json interface.signature"""
    ap = argparse.ArgumentParser(description="Generate UVM verification environment skeleton")
...
def main(argv=None) -> int:
    ...
    if errors:
        ...
        write_result(status="fail", module="env-builder", errors=errors,
    ...
    write_result(
        ...
        module=args.spec.stem if args.spec and args.spec.exists() else "env-builder",
